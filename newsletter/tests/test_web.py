...
class AnonymousSubscribeTestCase(WebSubscribeTestCase,
    ...
    def test_update_request_post_no_email(self):
        ...
        # email confirmation is switched off,
        # so after update request user should be subscribed
        self.assertTrue(changed_subscription.subscribed)
        self.assertFalse(changed_subscription.unsubscribed)
